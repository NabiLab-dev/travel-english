...
// 어머님 전용 버전입니다. (여러 명이 쓰는 배포용은 별도 폴더: 여행영어-배포용)
const OWNER = {
  "name": "문숙",              // 화면에 "문숙님의 여행회화"로 표시돼요
  "emoji": "👵🏻",              // 캐릭터 이미지가 없을 때 대신 보여줄 이모지
  "photo": "img/munsook.png",  // 캐릭터화한 어머님 사진 (이 이름으로 img 폴더에 넣어주세요)
  "gift": "최윤주가 만든 어머님 공부 선물"
};

const PROFILES = [
  { "id": "munsook", "name": "문숙", "emoji": "👵🏻" }
];
